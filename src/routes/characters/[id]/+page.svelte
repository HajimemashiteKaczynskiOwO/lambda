...
<div class="player-stats">
	{#if player}
		...
		{#if player.matches && player.matches > 0}
            ...
            ID: {mtc.player1Id}<button on:click={() => navigator.clipboard.writeText(mtc.player1Id)}>Copy ID</button>
            <br />
            ...
            ID: {mtc.player2Id}<button on:click={() => navigator.clipboard.writeText(mtc.player2Id)}>Copy ID</button>
            <br />
            ...
            ID: {mtc.winnerId}<button on:click={() => navigator.clipboard.writeText(mtc.winnerId)}>Copy ID</button>
            <br />
					</div>
				{/each}
			</div>
